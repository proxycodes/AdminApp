...
<x-layout.base-layout>
    <x-slot name="pageSeoTitle">Register</x-slot>
    <x-slot name="pageHeading">User Registration</x-slot>
        ...
        <form>
            ...
            <div class="row g-2">
                <div class="col p-1 input-group">
                    ...
                    <input type="email" class="form-control" id="userEmail" aria-describedby="emailHelp" placeholder="Enter Email ID">
                </div>    
            ...
            <div class="row g-2">
                <div class="col p-1 input-group">
                    ...
                    <input type="password" class="form-control" id="retypePassword"  placeholder="Re-Type Password" size="50">
                </div>
                <div class="col p-1"><label for="retypePassword" class="form-label"></label></div>
